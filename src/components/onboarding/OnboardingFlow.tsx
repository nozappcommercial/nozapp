...
type Reaction = "loved" | "disliked" | "unseen";
                            ...
                            <div className="ob-card-wrap">
                                ...
                                {!stepDone && (
                                    <div className="ob-rxn-row">
                                        ...
                                        <button className="ob-rxn-btn unseen" onClick={() => handleReaction("unseen")}>
                                            <span className="ob-rxn-icon" style={{ color: "var(--ob-ink-faint)" }}>○</span>
                                            <span className="ob-rxn-lbl">Non l&apos;ho<br />visto</span>
                                        </button>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="ob-pyramid-shell">
                            ...
                            {pillars.length === 0 ? (
                                ...
                                <div className="ob-pyramid">
                                    {rows.map((row, rowIdx) => (
                                        <div key={rowIdx} className="ob-pyr-row">
                                            {row.map((film) => {
...
.ob-pyr-card[data-rank="0"] { width: clamp(130px,16vw,196px); }
.ob-pyr-card[data-rank="1"],
.ob-pyr-card[data-rank="2"] { width: clamp(108px,13vw,160px); }
.ob-pyr-card[data-rank="3"],
.ob-pyr-card[data-rank="4"] { width: clamp(90px,11vw,132px); }
...
.ob-pyr-foot { display:flex; flex-direction:column; align-items:center; gap:12px; }
...
.ob-done-body { font-size:clamp(14px,2vw,17px); font-weight:300; color:var(--ob-ink-light); max-width:420px; line-height:1.75; margin:0 0 clamp(36px,5vh,56px) 0; animation: ob-au 0.55s 0.16s ease both; }
